...
def get_sql_generator_agent():
    return AssistantAgent(
        ...
        system_message="""你是一个专业的SQL生成智能体，你应确保只发言一次!!!!负责将自然语言转换为精确的SQL查询语句。
...
def get_critic_agent():
    return AssistantAgent(
        ...
        system_message="""你是一个专业的SQL语法分析智能体，负责验证和纠正SQL查询语句。
        工作流程：
...
def get_optimize_agent():
    return AssistantAgent(
        ...
        system_message="""你是一个专业的SQL优化智能体，负责提高SQL查询的执行效率。
        工作流程：
